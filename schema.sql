...
-- Raw SQL version for PostgreSQL
...
CREATE TABLE IF NOT EXISTS users (
    ...
    plaid_access_token TEXT,  -- Also used for Mono account ID
    
    -- Nigerian business specific fields
    business_name VARCHAR(255),
    cac_number VARCHAR(50),     -- CAC registration number
...
CREATE TABLE IF NOT EXISTS message_logs (
    ...
    message_type VARCHAR(50) NOT NULL, -- 'sms', 'whatsapp', 'email'
    direction VARCHAR(20) NOT NULL,    -- 'inbound', 'outbound'
    content TEXT NOT NULL,
    status VARCHAR(50) DEFAULT 'sent', -- 'sent', 'delivered', 'failed', 'read'
    external_id VARCHAR(255),          -- Twilio/provider message ID
...
-- Bank accounts table (for multiple account support)
CREATE TABLE IF NOT EXISTS bank_accounts (
    ...
    account_type VARCHAR(50), -- 'checking', 'savings', 'current'
    currency VARCHAR(10) DEFAULT 'NGN',
...
-- Categories table (for predefined business categories)
CREATE TABLE IF NOT EXISTS categories (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    name VARCHAR(255) NOT NULL,
    description TEXT,
    category_type VARCHAR(50) NOT NULL, -- 'income', 'expense', 'asset', 'liability'
    country VARCHAR(10) DEFAULT 'NG',
...
-- Insert Nigerian business categories
INSERT INTO categories (name, description, category_type, country, is_tax_deductible) VALUES
